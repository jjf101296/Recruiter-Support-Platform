...
import { Search, FileCheck, Map, StampIcon as Passport, FileText, Plane, Home } from "lucide-react"
...
export function ToolsNavigation({ showHomeLink = false }: { showHomeLink?: boolean }) {
  return (
